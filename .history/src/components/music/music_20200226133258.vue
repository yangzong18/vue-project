  ...
  <div class="music">
    <div class="music_content">
      ...
      <div class="music_ctrl circle" v-if="getCurrentMusic.name">
		  <div class="d-audio-circle" title="冬眠 - 司南"><img class="avatar" crossorigin="anonymous" src="https://p2.music.126.net/4KDBaQXnQywQovmqvjx-8Q==/109951164444131697.jpg?param=120y120"><div class="d-audio-range" style="border: 3px solid rgba(204, 188, 164, 0.36);"></div></div>
        <div class="left_ctrl">
