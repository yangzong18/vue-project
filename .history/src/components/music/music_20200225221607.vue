<template>
  <div class="music">
    ...
    <div class="music_content">
	  ...
	  <div class="d-audio-blur-bg" style="background-image: url(&quot;https://p2.music.126.net/6SLnR4WWW2EEQ-DV4_W4Nw==/109951164636919386.jpg?param=120y120&quot;);background-size: cover;background-position: center center;"></div>
    </div>
  </div>
</template>
<script>
