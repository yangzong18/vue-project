...
export default {
  ...
  methods:{
    ...
    GetOrderList(index) {
        setTimeout(function() {
          console.log(document.getElementsByClassName('swiper-item swiper-slide swiper-slide-activeswiper-slide-active'))
            var activeHight = document.getElementsByClassName('swiper-slide-active').height;
