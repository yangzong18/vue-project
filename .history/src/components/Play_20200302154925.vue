<template>
  <div id="play" class="play-music-page">
    ...
    <div class="button-group">
      <img class="blurbg" src="/static/img/Vue_Music_Blur.f29e504.png" />
...
import {mapMutations, mapState, mapGetters} from '@/store'
export default {
    methods:{
        hidePlayPage(){
    ...
    computed:{
        ...
        ...mapState([
            indicatorPosition:state=> state.PlayService.currentTime
        ])
    }
};
</script>
