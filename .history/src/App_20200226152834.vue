<template>
  <div class="app" @resize="isApp">
    ...
    <v-content></v-content>
    <div class="dw-react-web-lyric-comp show">
      <ul class="dw-react-web-lyric-comp-content"><li class="dw-react-web-lyric-comp-content-list">窗外不愿飞的蜂鸟</li></ul><span class="dw-react-web-lyric-comp-close"> 关闭 </span></div>
  </div>
</template>
<script>
