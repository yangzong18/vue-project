<template>
    ...
    <div class="md-modal modal-msg md-modal-transition" :class="{ 'md-show':addressClass }" id="showModaladd">
      <div class="md-modal-inner">
        ...
        <div class="md-content">
          <div class="btn-wrap col-2">
            <button class="btn btn--m" id="btnModalConfirm" @click="addAddressPost">保存</button>
            <button class="btn btn--m btn--red" id="btnModalCancel" @click="addressClass=false">取消</button>
          </div>
        </div>
      </div>
    </div>
    <div class="md-modal modal-msg md-modal-transition" :class="{ 'md-show':editClass }" id="showModaledit">
      <div class="md-modal-inner">
        ...
        <div class="md-content">
          <div class="btn-wrap col-2">
            <button class="btn btn--m" id="btnModalConfirm" @click="editAddressPost">保存</button>
            <button class="btn btn--m btn--red" id="btnModalCancel" @click="editClass=false">取消</button>
          </div>
        </div>
      </div>
    </div>
