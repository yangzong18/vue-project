              ...
              <div class="cart-foot-l">
                <div class="item-all-check">
                  <a href="javascript:void 0">
                    <span class="item-check-btn" @click="checkAll(true)">
                      <i class="iconfont " :class="selectAll ? 'iconcircle-chose-yellow':'iconcircle'"></i>
                    </span>
                    <span>全选</span>
                  </a>
                </div>
