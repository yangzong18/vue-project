  	...
  	<div class="music_content">
  		<div class="music_body">
  			...
  			<div class="right_info">
  				<div class="bg-info">
  					<img class="music-bg" :src="getCurrentMusic.picurl ? getCurrentMusic.picurl : './../../../static/dw.png'">
  				</div>
  		...
  		<div class="music_ctrl">
  			<div class="left_ctrl">
  				...
  				<div class="music_progress" id="music_progress" v-if="getCurrentMusic.name">
  					<div class="music_current_detail">
  						<span class="music_c_name">{{getCurrentMusic.name }} - {{getCurrentMusic.singer ? getCurrentMusic.singer : '戴维戴维'}}</span>
