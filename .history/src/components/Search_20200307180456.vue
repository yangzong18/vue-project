  ...
  <div id="search">
    ...
    <div class="result" v-if="searchRes != null && searchShow">
      ...
      <div class="result-group" v-if="searchRes.album != null">
        ...
        <div class="album-item" v-for="(item,index) in searchRes.album.itemlist" @click="showAlbum(item.mid)">
      ...
      <div class="result-group" v-if="searchRes.singer != null">
        ...
        <div class="singer-item" v-for="(item,index) in searchRes.singer.itemlist" :key @click="showSinger(item.mid)">
      ...
      <div class="result-group" v-if="searchRes.mv != null">
        ...
        <div class="mv-item" v-for="(mv,index) in searchRes.mv.itemlist" :key="index" @click="openmv(mv.vid)">
