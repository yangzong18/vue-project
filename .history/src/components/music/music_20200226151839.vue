<template>
  <div class="music">
    <div class="music_content">
      ...
      <div class="music_ctrl" :class="musicType" v-if="getCurrentMusic.name" @click="switchMusic">
        <div class="d-audio-circle" :title="getCurrentMusic.name +'-'+getCurrentMusic.singer">
          <img
            class="avatar"
            style="background-size: cover;background-position: center center;"
            :src="getCurrentMusic.picurl+'?param=120y120)'"
          />
        ...
        <div
          class="d-audio-blur-bg"
          v-show="false"
          style="background-size: cover;background-position: center center;"
          :style="{backgroundImage : 'url(' + getCurrentMusic.picurl + '?param=120y120)'}"
        ></div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    switchMusic(e){
      ...
      if(this.musicType == 'circle'){
        removeClass(e.currentTarget, 'circle')
      }else{
        addClass(e.currentTarget, 'circle')
      }
