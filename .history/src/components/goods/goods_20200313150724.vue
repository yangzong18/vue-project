...
export default {
    ...
    computed:{
        ...
        console.log(this.$refs.foodsWrapper)
            for (let i = 0; i < this.listHeight.length; i++) {
                ...
                if (!height2 || (this.$refs.foodsWrapper.scrollTop >= height1 && this.$refs.foodsWrapper.scrollTop < height2)) {
                    return i; // 返回当前索引
                }
            }
    ...
    mounted(){
        this.$nextTick(function() {
            ...
            foodsWrapper.addEventListener('scroll', ()=> {
                console.log(foodsWrapper.scrollTop)
                this.scrollY = foodsWrapper.scrollTop
            },false)
        });
    },
    components:{
