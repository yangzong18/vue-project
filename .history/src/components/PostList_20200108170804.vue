...
export default {
	...
	methods:{
		...
		getScrollData() {
			if (this.scroll) {
				window.onscroll = () => {
					console.log(document.documentElement.scrollTop,document.documentElement.innerHeight);
					// 距离底部200px时加载一次
					let bottomOfWindow = document.documentElement.scrollTop - document.documentElement.offsetHeight;
