  ...
  <div class="music">
    <div class="music_content">
      ...
      <div class="music_ctrl" v-if="getCurrentMusic.name">
		...
		<div class="d-audio-blur-bg" style="background-size: cover;
    background-position: center center;" :style="{backgroundImage : 'url(' + getCurrentMusic.picurl + ')', backgroundSize:imagesize, backgroundPosition:imageposition}"></div>
      </div>
