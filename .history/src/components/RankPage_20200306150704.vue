<template>
  <div id="rankpage">
    <div class="singer-photo">
      <img v-layz="imgurl" alt="singerphoto">
    </div>
    ...
    <div id="singer-header" class="header border-1px border-1px-after">
      ...
      <div class="header-warp" :style="{backgroud:gradientcolor}">
        <div class="singer-info" :class="{dark:isDark}">
          <h1 class="singer-name">巅峰榜·流行指数</h1>
          <p class="singer-fans">9.9万</p>
        </div>
...
export default {
  ...
  computed:{
    ...
    imgurl(){
      console.log(this.topListData.topinfo.pic_album.replace('http://imgcache.qq.com/','http://y.gtimg.cn/'))
        if (this.topListData !== null) {
