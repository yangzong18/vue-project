		...
		getScrollData() {
			if (this.scroll) {
				window.onscroll = () => {
					...
					console.log(document.documentElement.scrollTop,document.getElementById('page').offsetHeight);
					if (document.documentElement.scrollTop > document.getElementById('page').offsetHeight+200) {
                        this.scroll = false;
