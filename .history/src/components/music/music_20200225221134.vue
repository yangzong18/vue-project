<template>
  <div class="music">
    ...
    <div class="music_content">
      ...
      <div class="music_ctrl" v-if="getCurrentMusic.name" style="background-image: url('https://p2.music.126.net/6SLnR4WWW2EEQ-DV4_W4Nw==/109951164636919386.jpg?param=120y120');background-size: cover;background-position: center center;">
        <div class="left_ctrl">
