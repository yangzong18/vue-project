...
const musicApi = {
    ...
    getMusicList () {
        this.axios({
            url:"/api/top/list?idx=1&offset=0&limit=20",
            method:'get',
          })
        this.axios.get(`/api/top/list?idx=1&offset=0&limit=20`,{
          })
    ...
    getMusicSheet (id) {
        ...
        const apiUrl = `https://www.daiwei.site/php/web_v2_api/music.php?inAjax=1&do=playlist&id=${id}`
        fecth.get(apiUrl, {
            headers: {
    ...
    // 获取专辑信息
    getAlbum (id) {
        const apiUrl = `https://www.daiwei.site/php/web_v2_api/music.php?inAjax=1&do=album&id=${id}`
        fecth.get(apiUrl, {
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            }
    ...
    getMusicLrc (data, that) {
        ...
        // alert(data.id)
        const apiLyric = `https://www.daiwei.site/php/web_v2_api/music.php?inAjax=1&do=lyric&id=${data.id}`
    ...
    clickIndex (data, that) {
        ...
        const apiUrl = `https://www.daiwei.site/php/web_v2_api/music.php?inAjax=1&do=musicInfo&id=${reqId}`
