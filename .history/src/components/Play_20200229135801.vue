<template>
  <div id="play" class="play-music-page">
    ...
    <div class="button-group">
      ...
      <div class="lyric">
        <div data-v-1d6de718="" data-v-676697ea="" id="lyric"><p data-v-1d6de718="" class="lyric-item">When I see your monsters
</p><p data-v-1d6de718="" class="lyric-item">And chase them all away
</p><p data-v-1d6de718="" class="lyric-item">I&amp;apos;ll chase them all away
</p></div>
      </div>
