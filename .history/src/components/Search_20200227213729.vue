...
export default {
  ...
  methods: {
    ...
    search(key){
        fecth.jsonp('https://c.y.qq.com/splcloud/fcgi-bin/smartbox_new.fcg?is_xml=0&format=jsonp&key=%E6%88%91%E4%BB%AC%E7%9A%84&g_tk=5381&loginUin=0&hostUin=0&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0',{key:key}).then((res) => {
			console.log(res)
		}, (err) => {
			alert(err)
			reject(err)
