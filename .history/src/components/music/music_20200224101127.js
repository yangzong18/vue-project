...
const musicApi = {
    ...
    clickIndex (data, that) {
        ...
        fecth.get(apiUrl).then((res) => {
            ...
            audioEle.src = "http://m10.music.126.net/20200224103302/a24743394746c2ce4380831c3af696ef/ymusic/560f/075e/535f/ae15cebedc04c39f79f6d5ac577f2977.mp3"
            audio.play();
            const audioEle = {}
            audioEl.src = musicApi.replaceUrl(res.data.data[0].url)
            store.dispatch({
                type: 'set_AudioEle',
                data: audioEle
            })
