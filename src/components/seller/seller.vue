    ...
    <div class="seller-content">
      ...
      <div class="info">
        ...
        <ul>
          ...
          <li class="info-item">品类:其他菜系,包子粥店</li>
          <li class="info-item">北京市昌平区回龙观西大街龙观置业大厦底商B座102单元1340</li>
...
import { saveToLocal, loadFromLocal } from "@/store/favorite"; // 引入存储方法loadFromLocal
export default {
  props: {
    seller: {
      type: Object
  ...
  watch: {
    // 观测seller的更新
    'seller'() {
      // 这里观测一开始没有的东西，才能正确获取到并操作，因为seller一开始就是一个空的Object，所以pics肯定也是没有的
      this.$nextTick(() => {
        this._initPics();
      });
    }
