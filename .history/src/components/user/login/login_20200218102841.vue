        ...
        <div class="login_content">
            ...
            <div class="login_div" v-show="!status">
                ...
                <div class="block_area">
                    ...
                    <input type="password" id="userPwd" placeholder="登录密码">
                </div>
                <input type="button" value="登录">
            </div>
            <div class="register_div" v-show="status">
                <div class="block_area">
                    <label for="suserName">username</label>
                    <input type="text" id="suserName" placeholder="登录用户名">
                </div>
                <div class="block_area">
                    <label for="uuserPwd">password</label>
                    <input type="password" id="uuserPwd" placeholder="登录密码">
                </div>
                <input type="button" value="登录">
            </div>
        </div>
