<template>
  <div id="search">
    ...
    <div class="result">
      ...
      <div data-v-bba5be82 class="result-item">
        <p data-v-bba5be82 class="result-title">星辰大海</p>
        <p data-v-bba5be82 class="result-author">-周冬雨/王俊凯/易烊千玺/刘昊然</p>
        <div data-v-bba5be82 class="action-button">
          <img
            data-v-bba5be82
