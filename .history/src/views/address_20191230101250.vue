...
export default {
    ...
    methods:{
      ...
      editAddress:function(item){
        this.editClass = true;
        this.editId = item.addressId;
        this.editItem['addressId']=item.addressId;
        this.editItem['userName']=item.userName;
        this.editItem['streetName']=item.streetName;
        this.editItem['tel']=item.tel;
      },
      editAddressPost:function(){
        var editId = this.editId
        ,editItem = this.editItem;
        this.addressList.forEach(function(address,key){
          if (editId == address.addressId){
            // address.userName = editItem.userName;
            // address.streetName = editItem.streetName;
            // address.tel = editItem.tel;
            console.log(JSON.parse(JSON.stringify(editItem)))
            let address = JSON.parse(JSON.stringify(editItem))
            console.log(address)
          }
        })
        this.editItem = [];
