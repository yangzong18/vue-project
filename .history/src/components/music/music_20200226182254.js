...
const musicApi = {
    ...
    scrollLyric (time, that) {
        ...
        console.log(document.getElementsByClassName('dw-react-web-lyric-comp-content-list')[0])
        try {
            this.scrollAnimate(that.$refs.lrcWrapper, i * document.getElementsByClassName('dw-react-web-lyric-comp-content-list')[0].offsetHeight)
        } catch (e) {
            return
        }
    },
