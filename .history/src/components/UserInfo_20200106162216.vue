				...
				<div class="replies">
					...
					<ul>
						<li v-for="replie in UserInfo.recent_replies">
							<router-link :to="{name:'post_content',params:{id:post.id,name:post.author.loginname}}" :title="replie.title" >
								{{replie.title}}
							</router-link>

							{name:'post_content',params:{id:post.id,name:post.author.loginname}}
