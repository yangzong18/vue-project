...
export default {
	...
	methods:{
		...
		getScrollData() {
			if (this.scroll) {
				window.onscroll = () => {
					console.log(document.documentElement.scrollTop,document.getElementById('post-ul-li').offsetHeight,document.documentElement.scrollTop)
					//div 的高度 多出700px
					// if (document.documentElement.scrollTop > document.getElementById('post-ul-li').offsetHeight-700) {
                    //     this.scroll = false;
