<template>
    ...
    <div class="md-modal modal-msg md-modal-transition" :class="{ 'md-show':addClass }" id="showModaladd">
      <div class="md-modal-inner">
        <div class="md-top">
          <button class="md-close" @click="addClass=false">关闭</button>
        </div>
        <div class="md-content">
          <div class="confirm-tips">
            姓名<input type="text"/>
          ...
          <div class="btn-wrap col-2">
            <button class="btn btn--m" id="btnModalConfirm" @click="removeClass">保存</button>
            <button class="btn btn--m btn--red" id="btnModalCancel" @click="deleteClass=false">取消</button>
          </div>
        </div>
      </div>
    </div>
