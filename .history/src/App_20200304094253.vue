...
export default {
  ...
  methods:{
    ...
    GetOrderList(index) {
        setTimeout(function() {
          console.log(document.getElementsByClassName('swiper-item swiper-slide swiper-slide-active').offsetHeight)
            var activeHight = document.getElementsByClassName('swiper-slide-active')[0].height;
            console.log(document.getElementsByClassName('swiper-slide-active')[0].offsetHeight)
        }, 1000);
    },
