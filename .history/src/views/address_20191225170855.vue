...
<div class="address">
    ...
    <div class="container" v-cloak>
      <div class="checkout-addr">
            ...
            <ul>
              <li v-for="(item,index) in addressLimitBy" :class="{'check':index == currentIndex}" @click="getIndex(index)">
                ...
                <div class="addr-opration addr-del">
                  <a href="javascript:;" class="addr-del-btn" @click="removeItem(item)">
        ...
        <div class="md-modal modal-msg md-modal-transition" :class="{ 'md-show':addressClass }" id="showModalw">
          <form >
          <div class="md-modal-inner">
            <div class="md-top" @click="addressClass=false">
            ...
            <div class="md-content">
              <div class="confirm-tips">
                ...
                <div class="md-form-item">
                  ...
                  <div class="md-form-item__content" style="margin-left: 80px;">
                    <div  class="el-input">
                      <input type="text" name="streetName" autocomplete="off" class="md-input__inner" v-model="address.streetName">
                    </div>
                  </div>
                </div>
                <div class="md-form-item">
              ...
              <div class="btn-wrap col-2">
                <button class="btn btn--s" type="button" id="btnModalConfirms" @click="addAddressPost">保存</button>
                <button class="btn btn--s btn--red" id="btnModalCancels" type="button" @click="addressClass=false">取消</button>
              </div>
            </div>
          </div>
        </form>
