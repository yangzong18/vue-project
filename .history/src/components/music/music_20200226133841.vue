    ...
    <div class="music_content">
      ...
      <div class="music_ctrl circle" v-if="getCurrentMusic.name">
		<div class="d-audio-circle" title="冬眠 - 司南">
			<img class="avatar" crossorigin="anonymous" style="background-size: cover;background-position: center center;" :src="{backgroundImage : 'url(' + getCurrentMusic.picurl + '?param=120y120)'}">
