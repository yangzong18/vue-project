<template>
    <div class="album">
        ...
        <div class="play-list-page" v-if="album">
...
export default {
    ...
    methods:{
        showMenu: function (num) {
            ...
            menus: {
                'title.noop':`${this.album.list[num].songorig}<br/><span style="color:#666;font-size:12px;">${this.$options.filters['singer'](this.album.list[num].singer)}</span>`,
                playAsNext: '下一首播放',
