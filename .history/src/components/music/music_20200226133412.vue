  ...
  <div class="music">
    <div class="music_content">
      ...
      <div class="music_ctrl circle" v-if="getCurrentMusic.name">
		...
		<div class="d-audio-blur-bg" style="background-size: cover;background-position: center center;" :style="{backgroundImage : 'url(' + getCurrentMusic.picurl + '?param=120y120)'}"></div>
      </div>
