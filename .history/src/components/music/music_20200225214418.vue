  ...
  <div class="music">
  	...
  	<div class="music_content">
		...
		<div class="d-audio-circle" title="冬眠（女声吉他弹唱）（Cover：司南） - 李瑨瑶">
			<img class="avatar" crossorigin="anonymous" src="https://p2.music.126.net/Rd0NuqJiRAzylLsLoF4NMw==/109951164622384133.jpg?param=120y120"><div class="d-audio-range" style="border: 3px solid rgba(214, 198, 171, 0.36);"></div></div>
  	</div>
  </div>
</template>
<script>
