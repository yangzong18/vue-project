<template>
  <section id="sideBar" class="nav-list" :class="{'show':showMenu}">
    ...
    <section class="list-ul">
	  ...
	  <router-link class="icon-quanbu iconfont item" :to="{'name':'list',query:{tab:'job'}}">招聘</router-link>
	  <router-link class="icon-xiaoxi iconfont item" :to="{'name':'message',query:{tab:'all'}}">消息</router-link>
